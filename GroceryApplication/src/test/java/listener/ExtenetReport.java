...
public class ExtenetReport implements ITestListener {
	ExtentSparkReporter sparkReporter;//html conversion according to user requirements
	ExtentReports reports;
	ExtentTest test;//individual test
	...
	public void configureReport() {
		...
		reports.setSystemInfo("PC Name", "Aiswarya's PC");
		reports.setSystemInfo("OS", "Windows 11");
		reports.setSystemInfo("Test Done By", "Aiswarya Vineethan");		
